...
void Pair3DReconstruction::calculateFundamentalMatrix() {
	...
	fundamentalMatrix = findFundamentalMat(Mat(points1), Mat(points2), FM_RANSAC, 0.006 * 1, 0.99);
	//fundamentalMatrix = findFundamentalMat(Mat(points1), Mat(points2), CV_FM_8POINT, 3, 0.99);
	/*
...
Mat Pair3DReconstruction::GetFundamentalMat(const vector<KeyPoint>& imgpts1,
